-- DataHub PostgreSQL queue schema with time-partitioned message table for pg_partman.
-- Session: SET search_path + tokens __PGQUEUE_PREFIX__, __PGQUEUE_SCHEMA__. Requires init_pgqueue_03_partman.sql.
...
-- Partition key must appear in PRIMARY KEY and UNIQUE constraints (PostgreSQL declarative partitioning).
