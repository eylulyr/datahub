-- Register pg_partman parent for the queue message table. Session: SET search_path.
-- Java replaces __PARTMAN_PARENT_QUALIFIED__ with schema-qualified relation text for pg_partman APIs.
